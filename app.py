...
def compose_prompt(scene_label: str, scene_desc: str, use_exact_billgates: bool, num_refs: int) -> str:
    ...
    return (
        ...
        "MANDATORY PRESERVATION CHECKLIST - BODY & PHYSIQUE:\n"
        ...
        "The generated person must be INSTANTLY recognizable as the SAME individual from the references in BOTH face AND body, "
        "even by people who know them personally. Clothing and poses may vary for the scene but the underlying "
